...
export default function ShipmentDetailsList({ shipmentId, parentStatus }: ShipmentDetailsListProps) {
  ...
  const displayedDetails = useMemo(() => {
    return showAllItems ? details : details.slice(0, ITEMS_TO_SHOW_INITIALLY);
        ...
        {error && !isLoading && (
          <div className="my-4 p-4 bg-destructive/10 text-destructive rounded">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-medium">Error Loading Items</h4>
            </div>
            ...
            <Table>
              ...
              <TableBody>
                {displayedDetails.map((detail) => {
                  ...
                  const customerLabel = getLabel('customers', detail.customerId);
