...
// This file is no longer used as the sidebar has been replaced
// by a dropdown menu in the AppHeader.
...
//       <UiSidebarContent className="flex-1 overflow-y-auto p-0 group-data-[collapsible=icon]:px-2">
//          {authLoading ? (
...
//                  className="w-full space-y-1 p-2 group-data-[collapsible=icon]:hidden"
//              >
